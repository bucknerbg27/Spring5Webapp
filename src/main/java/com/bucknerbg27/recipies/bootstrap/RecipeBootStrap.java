package com.bucknerbg27.recipies.bootstrap;

import com.bucknerbg27.recipies.domain.*;
...
public class RecipeBootStrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        //Add Perfect Guacamole Recipe to Recipe List
        ...
        guacRecipe.addIngredient(new Ingredient("ripe tomato, seeds and pulp removed",new BigDecimal(".5"),eachUom));

        guacRecipe.getCategories().add(americanCategory);
        guacRecipe.getCategories().add(mexicanCategory);

        //Add Guacamole Recipe to list of recipies
        recipies.add(guacRecipe);

        //Add Spicy Grilled Chicken Tacos to Recipe List
        ...
        tacosRecipe.addIngredient(new Ingredient("Ancho chille powder",new BigDecimal(2),tableSpoonUom));
        ...
        tacosRecipe.addIngredient(new Ingredient("clove garlic, finely chopped",new BigDecimal(2),eachUom));
        ...
        tacosRecipe.addIngredient(new Ingredient("chopped cilantro",new BigDecimal(2),tableSpoonUom));
        tacosRecipe.addIngredient(new Ingredient("cup sour cream thinned with 1/4 cup milk",new BigDecimal(.5),cupUom));
        tacosRecipe.addIngredient(new Ingredient("lime, cut into wedges",new BigDecimal(1),eachUom));

        tacosRecipe.getCategories().add(americanCategory);
        tacosRecipe.getCategories().add(mexicanCategory);

        //Add Tacos to Recipe list
